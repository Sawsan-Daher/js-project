...
const product1=new products('ThinkPad p16 G1','2319 $','Lenovo','images/product1.jpg',1);
const product2=new products('Creator M16','1999 $','MSI','images/product2.jpg',2);
const product3=new products('AERO 16 OLED','1950 $','GIGABYTE','images/product3.jpg',3);
const product4=new products('Rog Strix G17','1747 $','ASUS','images/product4.jpg',4);
const product5=new products('Blade 17 Gamming','1580 $','Razer','images/product5.jpg',5);
const product6=new products('16Z90R-A.ADB9UI','1242 $','LG','images/product6.jpg',6);
const product7=new products('EliteBook 830 G9',' 767 $','HP','images/product7.jpg',7);
const product8=new products('Latitude 7420','544 $','DELL','images/product8.jpg',8);
const product9=new products('L510MA-DS02','235 $','ASUS','images/product9.png',9);
